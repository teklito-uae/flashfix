...
<main class="bg-gray-50 dark:bg-base dot-pattern">
    ...
    <section class="relative pt-20 pb-12 overflow-hidden bg-white dark:bg-surface">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <nav
                ...
                <span class="mx-2">/</span>
                <span class="text-blue-600 dark:text-blue-400">Next-Gen Firewall</span>
            </nav>

            <div class="max-w-3xl">
                <span
                    class="inline-block px-2 py-0.5 bg-blue-600/10 text-blue-600 dark:text-blue-400 text-[9px] font-extrabold uppercase tracking-widest rounded-full mb-3">Cyber
                    Perimeter Defense</span>
                <h1
                    ...
                    Next-Generation <span
                        class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-500">Firewall
                        (NGFW)</span> Solutions
                </h1>
                <p class="text-xs sm:text-sm text-gray-500 dark:text-slate-400 mb-6 leading-relaxed max-w-2xl">
                    Beyond traditional filtering. We deploy AI-powered NGFW solutions that provide deep packet
                    inspection, real-time threat intelligence, and granular application control to secure your
    ...
    <section class="py-12 relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-10 text-center lg:text-left">
                <span
                    class="text-[10px] tracking-widest uppercase font-bold text-red-500 mb-2 block font-extrabold">Network
                    Vulnerabilities</span>
                <h2
                    class="text-xl sm:text-2xl font-extrabold text-gray-900 dark:text-white tracking-tight font-[Poppins]">
                    Combating Modern Cyber Threats</h2>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div
                    ...
                    <h3 class="text-sm font-extrabold text-gray-900 dark:text-white mb-2 relative z-10">Legacy Gaps</h3>
                    <p class="text-[11px] text-gray-500 dark:text-slate-400 leading-relaxed mb-0 relative z-10">
                        Traditional port-based firewalls failing to detect sophisticated malware hiding within
                        authorized application traffic.</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="text-sm font-extrabold text-gray-900 dark:text-white mb-2 relative z-10">Zero-Day Attacks
                    </h3>
                    <p class="text-[11px] text-gray-500 dark:text-slate-400 leading-relaxed mb-0 relative z-10">New,
                        unidentified threats that bypass signature-based security before a formal patch or update is
                        released.</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="text-sm font-extrabold text-gray-900 dark:text-white mb-2 relative z-10">Insider Threats
                    </h3>
                    <p class="text-[11px] text-gray-500 dark:text-slate-400 leading-relaxed mb-0 relative z-10">
                        Unauthorized application usage and lateral movement within the network by compromised internal
                        devices or users.</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="text-sm font-extrabold text-gray-900 dark:text-white mb-2 relative z-10">Visibility Gaps
                    </h3>
                    <p class="text-[11px] text-gray-500 dark:text-slate-400 leading-relaxed mb-0 relative z-10">
                        Inability to see and control shadow IT applications being used by employees, increasing the
                        attack surface.</p>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-col lg:flex-row items-center gap-12">
                <div class="lg:w-1/2">
                    ...
                    <h2
                        ...
                        Advanced Perimeter logic</h2>
                    <p class="text-xs sm:text-sm text-gray-500 dark:text-slate-400 mb-6 leading-relaxed">
                        We don't just block ports; we understand behavior. Our NGFW solutions provide transparent
                        visibility into every packet, identifying and neutralizing threats before they reach your core
                        assets.
                    </p>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <h4 class="text-[13px] font-extrabold text-gray-900 dark:text-white mb-0.5">Deep Packet
                                    Intel</h4>
                                <p class="text-[10px] text-gray-500">Layer 7 application awareness.</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-3">
                            <div
                            ...
                            <div>
                                <h4 class="text-[13px] font-extrabold text-gray-900 dark:text-white mb-0.5">IPS
                                    Excellence</h4>
                                <p class="text-[10px] text-gray-500">Proactive breach prevention.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="lg:w-1/2 grid grid-cols-2 gap-4">
                    <div class="bg-gray-50 dark:bg-base p-6 rounded-[2rem] border border-gray-100 dark:border-white/5">
                        ...
                        <p class="text-[9px] uppercase font-bold tracking-widest text-gray-400">Threat Neutralization
                        </p>
                    </div>
                    <div class="bg-gray-50 dark:bg-base p-6 rounded-[2rem] border border-gray-100 dark:border-white/5">
                        <h4 class="text-2xl font-extrabold text-emerald-500 mb-1">Zero</h4>
                        <p class="text-[9px] uppercase font-bold tracking-widest text-gray-400">Day Protection</p>
                    </div>
                    <div class="bg-gray-50 dark:bg-base p-6 rounded-[2rem] border border-gray-100 dark:border-white/5">
                        <h4 class="text-2xl font-extrabold text-blue-600 mb-1">Layer 7</h4>
                        <p class="text-[9px] uppercase font-bold tracking-widest text-gray-400">Filtering Logic</p>
                    </div>
                    <div class="bg-gray-50 dark:bg-base p-6 rounded-[2rem] border border-gray-100 dark:border-white/5">
                        <h4 class="text-2xl font-extrabold text-emerald-500 mb-1">Managed</h4>
                        <p class="text-[9px] uppercase font-bold tracking-widest text-gray-400">Security SOC</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div
                        ...
                        <div
                            ...
                            1</div>
                        <h4 class="text-base font-extrabold text-gray-900 dark:text-white mb-2 font-[Poppins]">Threat
                            Audit</h4>
                        <p class="text-[11px] text-gray-500 dark:text-slate-500 leading-relaxed font-medium">Auditing
                            current traffic patterns and identifying high-risk app usage.</p>
                    </div>
                    <div
                        class="relative group text-center lg:text-left flex flex-col items-center lg:items-start transition-all">
                        <div
                        ...
                        <p class="text-[11px] text-gray-500 dark:text-slate-500 leading-relaxed font-medium">Drafting
                            granular firewall rules and web filtering profiles.</p>
                    </div>
                    <div
                        class="relative group text-center lg:text-left flex flex-col items-center lg:items-start transition-all">
                        <div
                        ...
                        <p class="text-[11px] text-gray-500 dark:text-slate-500 leading-relaxed font-medium">
                            Zero-downtime cutover from legacy firewalls to high-performance hardware.</p>
                    </div>
                    <div
                        class="relative group text-center lg:text-left flex flex-col items-center lg:items-start transition-all">
                        <div
                        ...
                        <p class="text-[11px] text-gray-500 dark:text-slate-500 leading-relaxed font-medium">Fine-tuning
                            prevention logic and setting up automated reports.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-white dark:bg-surface relative overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <span
                    class="text-[10px] tracking-widest uppercase font-bold text-blue-600 mb-2 block italic text-center italic font-extrabold">Defense
                    Stack</span>
                <h2
                    class="text-xl sm:text-2xl font-extrabold text-gray-900 dark:text-white tracking-tight font-[Poppins]">
                    Advanced Security Stack</h2>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                <div
                    ...
                    <h4 class="text-md font-extrabold text-gray-900 dark:text-white mb-3 font-[Poppins]">NGFW
                        Integration</h4>
                    <p class="text-[11px] text-gray-500 dark:text-slate-400 leading-relaxed mb-4">Implementation of
                        Fortinet, Palo Alto, and Sophos firewalls.</p>
                </div>
                <div
                    ...
                    <h4 class="text-md font-extrabold text-gray-900 dark:text-white mb-3 font-[Poppins]">IPS Prevention
                    </h4>
                    <p class="text-[11px] text-gray-500 dark:text-slate-400 leading-relaxed mb-4">Actively blocking
                        exploits and known vulnerabilities.</p>
                </div>
                <div
                    class="bg-gray-50 dark:bg-base p-8 rounded-[2rem] border border-gray-100 dark:border-white/5 hover:border-blue-500/30 transition-all group">
                    <div
                    ...
                    <h4 class="text-md font-extrabold text-gray-900 dark:text-white mb-3 font-[Poppins]">Secure VPN</h4>
                    <p class="text-[11px] text-gray-500 dark:text-slate-400 leading-relaxed mb-4">Encryption-backed
                        remote access for staff and site-to-site links.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-50 dark:bg-base overflow-hidden">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-10 text-center">
                <span
                    class="text-[10px] tracking-widest uppercase font-bold text-blue-600 mb-2 block font-extrabold">Security
                    Help</span>
                <h2
                    class="text-xl sm:text-2xl font-extrabold text-gray-900 dark:text-white tracking-tight font-[Poppins]">
                    Expert Queries</h2>
                ...
                <div
                    ...
                    <button class="w-full p-4 flex items-center justify-between text-left" onclick="toggleFaq(this)">
                        <h4 class="text-xs sm:text-sm font-extrabold text-gray-900 dark:text-white font-[Poppins]">Why
                            NGFW instead of a router firewall?</h4>
                    ...
                    <div class="max-h-0 overflow-hidden transition-all duration-300 bg-gray-50/50 dark:bg-base/50">
                        <div class="p-4 pt-0 text-[11px] text-gray-500 dark:text-slate-400 leading-relaxed">
                            NGFW performs deep packet inspection, identifying malware even within authorized application
                            traffic.
                        </div>
                    </div>
                </div>
    ...
    <section class="bg-gradient-to-r from-blue-700 via-blue-600 to-indigo-500 relative overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 relative z-10">
            <div class="flex flex-col lg:flex-row items-center justify-between gap-8 text-center lg:text-left">
                <div>
                    <h2 class="text-xl sm:text-2xl md:text-3xl font-extrabold text-white mb-2">Protect Your Network?
                    </h2>
                    <p class="text-xs text-blue-50/70">From startup offices to multi-site networks, we build defenses
                        that stay ahead.</p>
                </div>
                <div class="flex gap-4 items-center">
                    <a href="/contact.php"
                        class="px-7 py-2.5 bg-white text-blue-700 rounded-full font-extrabold text-xs shadow-lg">Request
                        Security Audit</a>
                    <a href="tel:+971505050505"
                        class="px-6 py-2.5 bg-transparent text-white border border-white/30 rounded-full font-extrabold text-xs">Talk
                        to Expert</a>
                </div>
            </div>
        </div>
